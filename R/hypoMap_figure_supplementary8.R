...
glp1r_neuron_map = FeaturePlot(neuron_map_seurat,features = "Glp1r",reduction =paste0("umap_scvi"),cols = cols_for_feature_plot, combine = TRUE,order = TRUE,pt.size = 0.2)+
  NoAxes() 
...
glp1r_snseq =FeaturePlot(query_snseq_neurons,features = "Glp1r",reduction =paste0("umap_scvi"),cols = cols_for_feature_plot, combine = TRUE,order = TRUE,pt.size = 0.2)+
  NoAxes() 
